...
def creat_model(args, pretrained = False):
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, representation_size=None, qkv_bias=False)
...
def main():
    ...
    parser.add_argument('--pertrain_file', type=str, default='./vit_base_patch16_224_miil_21k.pth')
